            ...
            <div className={styles.topGrid}>
                ...
                <div className={styles.kpiCard}>
                    ...
                    <h3 className={styles.kpiValue}>
                        {(reviews.reduce((s, r) => s + (r.rating || 0), 0) / (reviews.length || 1)).toFixed(1)} / 5.0
                    </h3>
                </div>
                <div className={styles.kpiCard}>
                        ...
                        <div key={item.id} className={styles.reviewCard}>
                            <div className={styles.cardHeader}>
                                <div className={styles.userInfo}>
                                    <div className={styles.avatar}>{(item.name || 'G').charAt(0)}</div>
                                    <div className={styles.nameGroup}>
                                        <span className={styles.userName}>{item.name || 'Guest'}</span>
                                        <span className={styles.userEmail}>{item.email || 'No Email'}</span>
                                    </div>
                                </div>
